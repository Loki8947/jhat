...
TOKEN = '7678663916:AAFH66PudLHxhH12oOJVGXP0aN5Q8cUaav0'
...
def list_approved_users(message):
    ...
    admin_id = 5123961345  # Replace with your admin ID or use a secure check
    ...
    user_list = "Approved Users:\n"
    for user in approved_users:
        user_list += (f"👤 User ID: `{user['user_id']}`\n"
                      f"💸 Plan: {user['plan']}\n"
